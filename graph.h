...
private :
    ...
    grman::WidgetText m_bouton_label;

    /// DEUXIEME BOUTON
    grman::WidgetBox m_boite2;
    grman::WidgetButton m_bouton2;
    grman::WidgetText m_bouton_label2;

    /// TROISIEME BOUTON
    grman::WidgetBox m_boite3;
    grman::WidgetButton m_bouton3;
    grman::WidgetText m_bouton_label3;

    /// QUATRIEME BOUTON
    grman::WidgetBox m_boite4;
    grman::WidgetButton m_bouton4;
    grman::WidgetText m_bouton_label4;

    /// CINQUIEME BOUTON
    grman::WidgetBox m_boite5;
